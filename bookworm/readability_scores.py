...
class ReadabilityScores():
    ...
    @staticmethod
    def calculate_flesch_kincaid_grade_level(syllable_count, word_count, sentence_count):
        score = 0.0
        if (word_count > 0):
    ...
    @staticmethod
    def calculate_flesch_reading_ease(syllable_count, word_count, sentence_count):
        score = 0.0
        if (word_count > 0):
            avg_sentence_length = word_count / sentence_count
            avg_syllables_per_word = syllable_count / word_count
    ...
    @staticmethod
    def calculate_gunning_fog_index(word_count, complex_word_count, sentence_count):
        score = 0.0
        if (word_count > 0):
            avg_sentence_length = word_count / sentence_count
    ...
    @staticmethod
    def calculate_lix(word_count, long_word_count, sentence_count):
        score = 0.0
        if (word_count > 0):
    ...
    @staticmethod
    def calculate_rix(long_word_count, sentence_count):
        score = 0.0
        if (sentence_count > 0):
    ...
    @staticmethod
    def calculate_smog(complex_word_count, sentence_count):
        score = 0.0
        if (sentence_count > 0):
